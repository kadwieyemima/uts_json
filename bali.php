<?php
  $json_string1 = file_get_contents("http://api.wunderground.com/api/f3578e3acf3429db/conditions/q/IA/Denpasar.json");
  $json_string2 = file_get_contents("http://api.wunderground.com/api/f3578e3acf3429db/forecast/q/IA/Denpasar.json");
  $json_string3 = file_get_contents("http://api.wunderground.com/api/0215dd2f84808f33/planner_07010731/q/IA/Denpasar.json");
